...
function Yd(a,b){var c=I("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.lf&&(!Hd(a)||b.withCredentials||Hd(a)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.M&&b.M[c])}
function Zd(a,b){var c=b.format||"JSON";b.mf&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=I("XSRF_FIELD_NAME",void 0),e=I("XSRF_TOKEN",void 0),f=b.ec;f&&(f[d]&&delete f[d],a=Rd(a,f||{}));var h=b.postBody||"",f=b.M;Yd(a,b)&&(f||(f={}),f[d]=e);f&&u(h)&&(d=Qd(h),ub(d,f),h=b.Oc&&"JSON"==b.Oc?JSON.stringify(d):Nd(d));var k=!1,l,n=Vd(a,function(a){if(!k){k=!0;l&&K(l);var d=Ud(a),e=null;if(d||400<=a.status&&500>a.status)e=
$d(c,a,b.kf);if(d)a:{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||m;d?b.Y&&b.Y.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.ac&&b.ac.call(f,a,e)}},b.method,h,b.headers,b.responseType,b.withCredentials);
...
function Ke(a){var b=Le.hd;return b?Ne(a,function(a){return!b||u(a.className)&&Qa(a.className.split(/\s+/),b)},!0,void 0):null}
...
;function ng(){this.f={apiaryHost:I("APIARY_HOST",void 0),jf:I("APIARY_HOST_FIRSTPARTY",void 0),gapiHintOverride:I("GAPI_HINT_OVERRIDE"),gapiHintParams:I("GAPI_HINT_PARAMS",void 0),innertubeApiKey:I("INNERTUBE_API_KEY",void 0),innertubeApiVersion:I("INNERTUBE_API_VERSION",void 0),Jd:I("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:I("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ld:I("INNERTUBE_CONTEXT_HL",void 0),Kd:I("INNERTUBE_CONTEXT_GL",void 0)}}
...
a.f.disable.html5=!d;d||(a.f.args.html5_unavailable="1")}c=!!a.f.disable.html5}b=c?Oh(a)?"flash":"unsupported":"html5"}("flash"==b?a.Ke:"html5"==b?a.Le:a.Me).call(a)}}
function Rh(a){var b=!0,c=Qh(a);c&&a.f&&(a=a.f,b=D(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
g.Le=function(){if(!this.qa){var a=Rh(this);a&&"html5"==Sh(this)?(this.A="html5",this.F||this.Ua()):(Th(this),this.A="html5",a&&this.P?(this.l.appendChild(this.P),this.Ua()):(this.f.loaded=!0,this.R=v(function(){var a=this.l,c=this.f.clone();r("yt.player.Application.create")(a,c);this.Ua()},this),this.qa=!0,a?this.R():(Cc(this.f.assets.js,this.R),Xf(this.f.assets.css))))}};
g.Ke=function(){var a=this.f.clone();if(!this.B){var b=Qh(this);b&&(this.B=document.createElement("span"),this.B.tabIndex=0,kg(this.ta,this.B,"focus",this.Bc),this.J=document.createElement("span"),this.J.tabIndex=0,kg(this.ta,this.J,"focus",this.Bc),b.parentNode&&b.parentNode.insertBefore(this.B,b),b.parentNode&&b.parentNode.insertBefore(this.J,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Sh(this))this.A="flash",this.F||Tf(a,!1,v(this.Ua,this));
...
function Ih(a){a.F=!1;if(a.va)for(var b in a.j)a.va(b,a.j[b]);for(var c in a.ua)K(parseInt(c,10));a.ua={};a.S=null;a.va=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=v(a.xa,a);a.api.removeEventListener=v(a.we,a);a.api.destroy=v(a.dispose,a);a.api.getLastError=v(a.Bd,a);a.api.getPlayerType=v(a.Cd,a);a.api.getCurrentVideoConfig=v(a.zd,a);a.api.loadNewVideoConfig=v(a.gc,a);a.api.isReady=v(a.Xe,a)}
g.Xe=function(){return this.F};
...
g.we=function(a,b){if(!this.isDisposed()){var c=Nh(this,b);c&&this.ha.unsubscribe(a,c)}};
...
g.$d=function(a){Ph(this,a)};
g.ae=function(a){L("WATCH_LATER_VIDEO_ADDED",a)};
g.be=function(a){L("WATCH_LATER_VIDEO_REMOVED",a)};
g.Xd=function(){this.Jb||(Df?(this.Za=Be(document),kg(this.K,window,"scroll",this.re),kg(this.K,this.l,"touchmove",this.le)):(kg(this.K,this.l,"mousewheel",this.Ec),kg(this.K,this.l,"wheel",this.Ec)),this.Jb=!0)};
g.Yd=function(){lg(this.K);this.Jb=!1};
g.Ec=function(a){a=a||window.event;a.returnValue=!1;a.preventDefault&&a.preventDefault()};
g.re=function(){window.scrollTo(this.Za.x,this.Za.y)};
g.le=function(a){a.preventDefault()};
g.Me=function(){Th(this);this.A="unsupported";var a='Adobe Flash Player or an HTML5 supported browser is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="/html5">Learn more about upgrading to an HTML5 browser</a>',b=navigator.userAgent.match(/Version\/(\d).*Safari/);b&&5<=parseInt(b[1],10)&&(a='Adobe Flash Player or QuickTime is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/"> Get the latest Flash Player</a> <br> <a href="http://www.apple.com/quicktime/download/">Get the latest version of QuickTime</a>');
...
g.Cd=function(){return this.A||Sh(this)};
g.Bd=function(){return this.Lb};
...
y(Yi,Ki);ba(Yi);Yi.prototype.register=function(){Ni(this,"click",this.Ob);Mi(this,ti,this.Dc);Mi(this,ui,this.Cc);Mi(this,vi,this.je);Mi(this,yi,this.Dc);Mi(this,zi,this.Cc);Mi(this,Ai,this.pe);Mi(this,Ci,this.Wd);Mi(this,Di,this.Vd)};
Yi.prototype.unregister=function(){Oi(this,"click",this.Ob);Yi.I.unregister.call(this)};
var Le={hc:"hover-enabled",fd:"yt-uix-button-subscribe",gd:"yt-uix-button-subscribed",Ze:"ypc-enabled",hd:"yt-uix-button-subscription-container",jd:"yt-subscription-button-disabled-mask-container"},Zi={$e:"channel-external-id",kd:"subscriber-count-show-when-subscribed",ld:"subscriber-count-tooltip",md:"subscriber-count-title",af:"href",ic:"is-subscribed",cf:"parent-url",ef:"clicktracking",nd:"style-type",jc:"subscription-id",hf:"target",od:"ypc-enabled"};g=Yi.prototype;
...
g.je=function(a){this.Qa(a.f,this.Uc,!0,a.subscriptionId)};
g.pe=function(a){this.Qa(a.f,this.Uc,!1)};
g.Wd=function(a){this.Qa(a.f,this.vd)};
g.Vd=function(a){this.Qa(a.f,this.ud)};
g.Uc=function(a,b,c){b?(Mb(a,Zi.ic,"true"),c&&Mb(a,Zi.jc,c)):(Ob(a,Zi.ic),Ob(a,Zi.jc));aj(a)};
g.Tc=function(a,b){var c;c=Ke(a);oe(c,Le.jd,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function aj(a){var b=D(a,Zi.nd),c=!!D(a,"is-subscribed"),b="-"+b,d=Le.gd+b;oe(a,Le.fd+b,!c);oe(a,d,c);D(a,Zi.ld)&&!D(a,Zi.kd)&&(b=Li(Qi.getInstance()),oe(a,b,!c),a.title=c?"":D(a,Zi.md));c?J(function(){me(a,Le.hc)},1E3):ne(a,Le.hc)}
...
;var jk={Ye:"atp",gf:"ska",df:"que",bf:"mus",ff:"sus"};function kk(a){this.l=this.j="";this.f="/api/lounge";this.h=!0;a=a||document.location.href;var b=Number(a.match(Gd)[4]||null)||null||"";b&&(this.l=":"+b);this.j=Hd(a)||"";a=vb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ha(a,"10.0")&&(this.h=!1))}
...
g.Nc=function(){this.h=NaN;this.f=Zd(lk(this.F,"/pairing/get_screen"),{method:"POST",M:{pairing_code:this.B},timeout:5E3,Y:v(this.Pe,this),onError:v(this.Oe,this),Na:v(this.Qe,this)})};
g.Pe=function(a,b){this.f=null;var c=b.screen||{};c.dialId=this.o;c.name=this.A;this.D("pairingComplete",new ak(c))};
g.Oe=function(a){this.f=null;a.status&&404==a.status?this.j>=Ek.length?this.D("pairingFailed",Error("DIAL polling timed out")):(a=Ek[this.j],this.h=J(v(this.Nc,this),a),this.j++):this.D("pairingFailed",Error("Server error "+a.status))};
...
mk(a.h,c,{screen_ids:b.join(",")},v(a.Fd,a),v(a.Ed,a))}}
g.Fd=function(a){al(this);var b=this.screens.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}cl(this,!b);b&&Xj(this.B,"Missed "+b+" lounge tokens.")};
g.Ed=function(a){Xj(this.B,"Requesting lounge tokens failed: "+a)};
...
g.bc=function(){K(this.j);this.j=NaN;this.h&&this.h.abort();var a=jl(this);if(fb(a)){var b=lk(this.B,"/pairing/get_screen_availability"),c={lounge_token:kb(a).join(",")};this.h=mk(this.B,b,c,v(this.he,this,a),v(this.ge,this))}else gl(this,{}),fl(this)};
g.he=function(a,b){this.h=null;var c=kb(jl(this));if(ab(c,kb(a))){for(var c=b.screens||[],d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;gl(this,d);fl(this)}else this.N("Changing Screen set during request."),this.bc()};
g.ge=function(a){this.N("Screen availability failed: "+a);this.h=null;fl(this)};
...
g.Se=function(a,b,c,d){Zd(lk(this.A,"/pairing/get_screen"),{method:"POST",M:{pairing_code:a},timeout:5E3,Y:v(function(a,d){var h=new ak(d.screen||{});if(!h.name||ol(this,h.name))h.name=this.xc(h.name,b);c(ml(this,h))},this),
...
g.Gd=function(){pl(this);this.D("screenChange");this.f.update()};
function kl(a){ql(a);a.h=new $k(a.A);a.h.subscribe("screenChange",v(a.Gd,a));pl(a);a.j=gk(vj("yt-remote-automatic-screen-cache")||[]);ql(a);a.info("Initializing automatic screens: "+ik(a.j));a.f=new dl(a.A,v(a.aa,a,!0));a.f.subscribe("screenChange",v(function(){this.D("onlineScreenChange")},a))}
...
g.G=function(){this.dc("");rl.I.G.call(this)};function tl(a,b){rl.call(this,a,b,"CastSession");this.f=null;this.A=0;this.o=null;this.F=v(this.Te,this);this.B=v(this.se,this);this.A=J(v(function(){ul(this,null)},this),12E4)}
...
g.se=function(a,b){if(!this.isDisposed())if(b){var c=zd(b);if(c){var d=""+c.type,c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+N(c));switch(d){case "mdxSessionStatus":ul(this,c.screenId);break;default:sl(this,"Unknown youtube message: "+d)}}else sl(this,"Unable to parse message.")}else sl(this,"No data in message.")};
...
g.Te=function(a){this.isDisposed()||a||(sl(this,"Cast session died."),this.ca())};function xl(a,b){rl.call(this,a,b,"DialSession");this.A=this.J=null;this.P="";this.o=null;this.F=t;this.B=NaN;this.R=v(this.We,this);this.f=t}
...
this.ca(a)},a))}
g.We=function(a){this.isDisposed()||a||(sl(this,"DIAL session died."),this.f(),this.f=t,this.ca())};
...
g.Hd=function(a,b){ll(this.K,this.J.receiver.label,a,this.h.friendlyName,v(function(a){a&&a.token?(this.xb(a),b(new chrome.cast.DialLaunchResponse(!1))):this.Zb(b)},this),v(function(a){sl(this,"Failed to get DIAL screen: "+a);
...
g.Ge=function(a){this.isDisposed()?this.N("Setting connection data on disposed cast v2"):this.f?this.f.Ta(a):this.N("Setting connection data without a session")};
g.Ve=function(){this.isDisposed()?this.N("Stopping session on disposed cast v2"):this.f?(this.f.stop(),ec(this.f),this.f=null):Fl("Stopping non-existing session")};
g.requestSession=function(){chrome.cast.requestSession(v(this.Hc,this),v(this.ie,this))};
...
g.Ue=function(){return this.f?this.f.bd():null};
g.ie=function(a){this.isDisposed()||(this.N("Failed to estabilish a session: "+N(a)),a.code!=chrome.cast.ErrorCode.CANCEL&&Hl(this,null))};
g.fe=function(a){Fl("Receiver availability updated: "+a);if(!this.isDisposed()){var b=El(this);this.A=a==chrome.cast.ReceiverAvailability.AVAILABLE;El(this)!=b&&this.D("yt-remote-cast2-availability-change",El(this))}};
...
Bl.prototype.setLaunchParams=Bl.prototype.Ge;Bl.prototype.setConnectedScreenStatus=Bl.prototype.Fe;Bl.prototype.stopSession=Bl.prototype.Ve;Bl.prototype.getCastSession=Bl.prototype.Ue;Bl.prototype.requestSession=Bl.prototype.requestSession;Bl.prototype.init=Bl.prototype.init;Bl.prototype.dispose=Bl.prototype.dispose;function Il(a,b,c){Jl()?Ll(a)&&(Ml(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?Nl(b):(window.__onGCastApiAvailable=function(a,c){a?Nl(b):(Ol("Failed to load cast API: "+c),Pl(!1),Ml(!1),wj("yt-remote-cast-available"),wj("yt-remote-cast-receiver"),Ql(),b(!1))},c?Cc("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):Nj())):Kl("Cannot initialize because not running Chrome")}
...
y(hn,pa);hn.prototype.name="cancel";function sn(a,b){Xm.call(this);this.f=a||1;this.h=b||m;this.l=v(this.Ie,this);this.o=x()}
y(sn,Xm);g=sn.prototype;g.enabled=!1;g.ea=null;function tn(a,b){a.f=b;a.ea&&a.enabled?(a.stop(),a.start()):a.ea&&a.stop()}
g.Ie=function(){if(this.enabled){var a=x()-this.o;0<a&&a<.8*this.f?this.ea=this.h.setTimeout(this.l,this.f-a):(this.ea&&(this.h.clearTimeout(this.ea),this.ea=null),Ym(this,"tick"),this.enabled&&(this.ea=this.h.setTimeout(this.l,this.f),this.o=x()))}};
...
;function vn(a,b,c){E.call(this);this.l=null!=c?v(a,c):a;this.j=b;this.h=v(this.ke,this);this.f=[]}
y(vn,E);g=vn.prototype;g.Wa=!1;g.jb=0;g.Ja=null;g.xd=function(a){this.f=arguments;this.Ja||this.jb?this.Wa=!0:wn(this)};
...
g.ke=function(){this.Ja=null;this.Wa&&!this.jb&&(this.Wa=!1,wn(this))};
...
g.te=function(){var a=Mn(this.O),b=Nn(this.O);this.nb<b.length&&(On(this),Qn(this,a,b),this.ma&&4!=a&&Ln(this))};
...
k+=l.toString(16).toUpperCase()}h=Ga[h]=k}e+=h}}d+='<script>document.domain="'+e+'"\x3c/script>'}d+="</body></html>";c=Oc(Ab("b/12014412"),d);a.na.open();a.na.write(Jb(c));a.na.close();a.na.parentWindow.m=v(a.oe,a);a.na.parentWindow.d=v(a.Lc,a,!0);a.na.parentWindow.rpcClose=v(a.Lc,a,!1);c=a.na.createElement("DIV");a.na.parentWindow.document.body.appendChild(c);d=Fb(a.Ea.toString());d=Db(d);Aa.test(d)&&(-1!=d.indexOf("&")&&(d=d.replace(ua,"&amp;")),-1!=d.indexOf("<")&&(d=d.replace(va,"&lt;")),-1!=
...
g.oe=function(a){Vn(v(this.ne,this,a),0)};
g.ne=function(a){this.Ga||(On(this),Rn(this,a),Ln(this))};
g.Lc=function(a){Vn(v(this.me,this,a),0)};
g.me=function(a){this.Ga||(Pn(this),this.ma=a,this.f.wb(this),this.f.la(4))};
g.cancel=function(){this.Ga=!0;Pn(this)};
function Ln(a){a.fc=x()+a.o;Wn(a,a.o)}
function Wn(a,b){if(null!=a.Ya)throw Error("WatchDog timer not null");a.Ya=Vn(v(a.qe,a),b)}
function On(a){a.Ya&&(m.clearTimeout(a.Ya),a.Ya=null)}
g.qe=function(){this.Ya=null;var a=x();0<=a-this.fc?(2!=this.Xa&&this.f.la(3),Pn(this),this.La=2,X(),Sn(this)):Wn(this,this.fc-a)};
...
g.Fc=function(){this.isDisposed()||(this.ha||this.F||this.l?ro(this):this.ce())};
g.ce=function(){ro(this)};
...
g=so.prototype;g.cb=null;g.Z=null;g.L=null;g.Ub=null;g.rb=null;g.mc=null;g.sb=null;g.ib=0;g.Nd=0;g.U=null;g.Da=null;g.ya=null;g.Ia=null;g.Ca=null;g.Gb=null;g.Sa=-1;g.Ac=-1;g.ia=-1;g.eb=0;g.Ra=0;g.Ha=8;var uo=new Xm;function vo(a){wm.call(this,"statevent",a)}
...
function Do(a,b){if(0==a.f)throw Error("Invalid operation: sending map when state is closed");a.h.push(new to(a.Nd++,b));2!=a.f&&3!=a.f||Eo(a)}
...
g.Od=function(){null!=this.Ia&&(this.Ia=null,this.L.cancel(),this.L=null,Jo(this),X())};
...
function fo(a,b){if(2==b||9==b){var c=null;a.U&&(c=null);var d=v(a.He,a);c||(c=new vg("//www.google.com/images/cleardot.gif"),Lg(c));Zn(c.toString(),1E4,d)}else X();Lo(a,b)}
g.He=function(a){a?X():(X(),Lo(this,8))};
...
;function Po(a,b){this.sa=a;this.l=b;this.j=new H;this.h=new No(this.Ne,this);this.f=null;this.J=!1;this.A=null;this.T="";this.F=this.o=0;this.B=[]}
...
g.Ne=function(){this.h.stop();var a=this.f,b=0;a.L&&b++;a.Z&&b++;0!=b?this.h.start():this.connect(this.A,this.o)};function To(a){this.videoIds=null;this.index=-1;this.videoId=this.f="";this.volume=this.h=-1;this.o=!1;this.audioTrackId=null;this.A=this.l=0;this.j=null;this.reset(a)}
...
To.prototype.clone=function(){return new To(Zo(this))};function Y(a,b,c){V.call(this);this.A=NaN;this.S=!1;this.J=this.F=this.R=this.K=NaN;this.$=[];this.j=this.C=this.f=null;this.Pa=a;this.$.push(O(window,"beforeunload",v(this.Dd,this)));this.h=[];this.C=new To;3==c["mdx-version"]&&(this.C.f="RQ"+b.token);this.ha=b.id;this.f=$o(this,c);this.f.subscribe("handlerOpened",this.Td,this);this.f.subscribe("handlerClosed",this.Pd,this);this.f.subscribe("handlerError",this.Qd,this);this.C.f?this.f.subscribe("handlerMessage",this.Rd,this):this.f.subscribe("handlerMessage",
this.Sd,this);So(this.f,b.token);this.subscribe("remoteQueueChange",function(){var a=this.C.videoId;Kk()&&U("yt-remote-session-video-id",a)},this)}
y(Y,V);g=Y.prototype;
...
g.Td=function(){this.H("Channel opened");this.S&&(this.S=!1,ep(this),this.K=J(v(function(){this.H("Timing out waiting for a screen.");this.o(1)},this),15E3));
Xk(Ro(this.f),this.ha)};
g.Pd=function(){this.H("Channel closed");isNaN(this.A)?Yk(!0):Yk();this.dispose()};
g.Qd=function(a){Yk();isNaN(this.B())?(this.H("Channel error: "+a+" without reconnection"),this.dispose()):(this.S=!0,this.H("Channel error: "+a+" with reconnection in "+this.B()+" ms"),bp(this,2))};
...
g.Rd=function(a){a.params?this.H("Received: action="+a.action+", params="+N(a.params)):this.H("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=yd(a.params.devices);this.h=B(a,function(a){return new Fk(a)});
...
g.xe=function(){if(this.j){var a=this.j;this.j=null;this.C.videoId!=a&&gp(this,"getNowPlaying")}};
...
Y.prototype.getPlayerContextData=Y.prototype.ta;Y.prototype.Aa=function(a){var b=new To(a);b.videoId&&b.videoId!=this.C.videoId&&(this.j=b.videoId,K(this.F),this.F=J(v(this.xe,this),5E3));var c=[];this.C.f==b.f&&this.C.videoId==b.videoId&&this.C.index==b.index&&ab(this.C.videoIds,b.videoIds)||c.push("remoteQueueChange");this.C.h==b.h&&this.C.volume==b.volume&&this.C.o==b.o&&Xo(this.C)==Xo(b)&&N(this.C.j)==N(b.j)||c.push("remotePlayerChange");this.C.reset(a);z(c,function(a){this.D(a)},this)};
...
wc("yt-remote-cast-device-status-update",a.Je,a);a.Qc();var b=x()>a.o?2E4:1E4;mc(v(a.Qc,a),b)}
...
g.Je=function(a){var b=wk(this.h,a.id);b&&(this.H("Updating DIAL device: "+b.id+"("+b.name+") from status: "+b.status+" to status: "+a.status+" and from activityId: "+b.f+" to activityId: "+a.f),b.f=a.f,b.status=a.status,Vk(tk(this.h)));vp(this,this.f)};
...
;function Kp(a){zk.call(this,"ScreenServiceProxy");this.X=a;this.f=[];this.f.push(this.X.$_s("screenChange",v(this.Re,this)));this.f.push(this.X.$_s("onlineScreenChange",v(this.Zd,this)))}
...
g.Re=function(){this.D("screenChange")};
g.Zd=function(){this.D("onlineScreenChange")};
W.prototype.$_st=W.prototype.start;W.prototype.$_gspc=W.prototype.Se;W.prototype.$_gsppc=W.prototype.$c;W.prototype.$_c=W.prototype.contains;W.prototype.$_g=W.prototype.get;W.prototype.$_a=W.prototype.Ib;W.prototype.$_un=W.prototype.Fb;W.prototype.$_r=W.prototype.remove;W.prototype.$_gs=W.prototype.aa;W.prototype.$_gos=W.prototype.Zc;W.prototype.$_s=W.prototype.subscribe;W.prototype.$_ubk=W.prototype.oa;function Lp(){var a=!!I("MDX_ENABLE_CASTV2"),b=!!I("MDX_ENABLE_QUEUE"),c={device:"Desktop",app:"youtube-desktop"};a?q("yt.mdx.remote.castv2_",!0,void 0):hm();tj&&sj();Hk();Mp||(Mp=new kk,Zk()&&(Mp.f="/api/loungedev"));Z||a||(Z=new rp(Mp),Z.subscribe("screenPair",Np),Z.subscribe("managedScreenChange",Op),Z.subscribe("onlineReceiverChange",function(){L("yt-remote-receiver-availability-change")}));
...
;var Aq=null,Bq=[];function Cq(a){return{externalChannelId:a.externalChannelId,Md:!!a.isChannelPaid,source:a.source,subscriptionId:a.subscriptionId}}
function Dq(a){Eq(Cq(a))}
function Eq(a){Fi()?(S(si,new mi(a.externalChannelId,a.Md?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Nd({event:"subscribe",source:a.source}))&&$g(a)):Fq(a)}
...
g.Pc=function(a,b){if(this.l&&!this.isDisposed()){var c=b||{};switch(a){case "addEventListener":if(u(c.event)&&(c=c.event,!(c in this.j))){var d=v(this.ze,this,c);this.j[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":u(c.event)&&Lq(this,c.event);break;default:this.f.isReady()&&this.f[a]&&(c=Mq(a,b||{}),c=this.f[a].apply(this.f,c),(c=Nq(a,c))&&this.l&&!this.isDisposed()&&Kq(this.h,a,c))}}};
g.ze=function(a,b){this.l&&!this.isDisposed()&&Kq(this.h,a,this.Rb(a,b))};
...
Oq.prototype.G=function(){Oq.I.G.call(this);delete this.f};function Pq(){var a=this.h=new dj,b=v(this.ve,this);a.h=b;a.j=null;this.l=[];this.A=!1;this.o={}}
g=Pq.prototype;g.ve=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.o[c]||"onReady"==c||(this.addEventListener(c,Qq(this,c)),this.o[c]=!0)}else this.cd(a,b)};
g.cd=function(){};
function Qq(a,b){return v(function(a){this.sendMessage(b,a)},a)}
g.addEventListener=function(){};
g.yd=function(){this.A=!0;this.sendMessage("initialDelivery",this.Sb());this.sendMessage("onReady");z(this.l,this.ed,this);this.l=[]};
...
g.dispose=function(){this.h=null};function Sq(a){Pq.call(this);this.f=a;this.j=[];this.addEventListener("onReady",v(this.de,this));this.addEventListener("onVideoProgress",v(this.De,this));this.addEventListener("onVolumeChange",v(this.Ee,this));this.addEventListener("onApiChange",v(this.ye,this));this.addEventListener("onPlaybackQualityChange",v(this.Ae,this));this.addEventListener("onPlaybackRateChange",v(this.Be,this));this.addEventListener("onStateChange",v(this.Ce,this))}
...
g.de=function(){var a=v(this.yd,this);this.h.f=a};
...
g.Ee=function(){Rq(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
g.De=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Rq(this,a)};
g.dispose=function(){Sq.I.dispose.call(this);for(var a=0;a<this.j.length;a++){var b=this.j[a];this.f.removeEventListener(b.eventType,b.listener)}this.j=[]};function Tq(a,b,c){V.call(this);this.f=a;this.h=b;this.j=c}
